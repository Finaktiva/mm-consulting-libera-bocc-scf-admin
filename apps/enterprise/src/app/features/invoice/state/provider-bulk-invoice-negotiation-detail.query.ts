...
import {
    ProviderBulkInvoiceNegotiationDetailStore,
    ProviderBulkInvoiceNegotiationDetailUIState,
} from './provider-bulk-invoice-negotiation-detail.store';
import { SharedBulkInvoiceNegotiationQuery } from './shared-bulk-invoice-negotiation-detail.query';

@Injectable({
    providedIn: 'root',
})
export class ProviderBulkInvoiceNegotiationDetailQuery
    extends EntityQuery<
        BulkInvoiceNegotiationDetail,
        ProviderBulkInvoiceNegotiationDetailUIState
    >
    implements SharedBulkInvoiceNegotiationQuery {
    constructor(private store: ProviderBulkInvoiceNegotiationDetailStore) {
        super(store);
    }
