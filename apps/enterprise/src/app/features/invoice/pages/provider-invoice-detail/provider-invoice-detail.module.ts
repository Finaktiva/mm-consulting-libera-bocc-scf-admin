...
import { ProviderInvoiceDetailPage } from './provider-invoice-detail.page';
...
@NgModule({
    ...
    declarations: [ProviderInvoiceDetailPage],
    exports: [ProviderInvoiceDetailPage],
})
export class ProviderInvoiceDetailPageModule { }
