...
import { ProviderBulkInvoiceNegotiationListPage } from './provider-bulk-invoice-negotiation-list.page';
...
@NgModule({
    ...
    declarations: [ProviderBulkInvoiceNegotiationListPage],
    exports: [ProviderBulkInvoiceNegotiationListPage],
})
export class ProviderBulkInvoiceNegotiationListPageModule {}
