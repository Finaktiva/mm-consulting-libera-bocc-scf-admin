...
@Component({
    selector: 'bulk-invoice-negotiation-reject-offer',
    templateUrl: './bulk-invoice-negotiation-reject-offer.dialog.html',
...
export class BulkInvoiceNegotiationRejectOfferDialog {
    isSubmitting$: Observable<
        boolean
    > = this.query.selectUIEntityRejectingOffer(this.data.id);
