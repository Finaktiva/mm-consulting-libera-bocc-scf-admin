...
@Component({
    selector: 'request-quota-expansion-dialog',
    templateUrl: './request-quota-expansion-dialog.component.html',
    styles: [],
})
export class RequestQuotaExpansionDialogComponent implements OnInit {
